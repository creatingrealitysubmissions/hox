		...
		public virtual void FireRequest (Action<object, AsyncCompletedEventArgs> callback = null) {
			...
			try {
				using ( client = new WebClient () ) {
					...
					form.Add("client_id", ForgeLoaderConstants.FORGE_CLIENT_ID);
					form.Add("client_secret", ForgeLoaderConstants.FORGE_CLIENT_SECRET);
					form.Add("grant_type", "client_credentials");
					form.Add("scope", "viewables:read%20data:read");

					string data ="client_id=" + ForgeLoaderConstants.FORGE_CLIENT_ID
						+ "&client_secret=" + ForgeLoaderConstants.FORGE_CLIENT_SECRET
