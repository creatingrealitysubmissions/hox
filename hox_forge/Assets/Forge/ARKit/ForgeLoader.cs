...
namespace Autodesk.Forge.ARKit {
	...
	public class ForgeLoader : MonoBehaviour {
		...
		#region Methods
		protected void Load (string urn, string sceneID, string bearer, bool loadMetdata =true, bool loadMesh =true) {
			gameObject.SetActive (false);
			URN = urn;
			BEARER = bearer;
			SCENEID = sceneID;
			LoadMesh = loadMesh;
			LoadMetadata = loadMetdata;
			gameObject.SetActive (true);
		}

		public static ForgeLoader AddLoaderToGameObject (GameObject root, string urn, string sceneID, string bearer, bool loadMetdata =true, bool loadMesh =true) {
			if ( root == null )
			...
			loader.LoadMetadata = loadMetdata;
			root.SetActive (true);
			return (loader);
		}
