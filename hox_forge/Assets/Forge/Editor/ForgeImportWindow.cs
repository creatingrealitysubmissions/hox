...
namespace Autodesk.Forge.ARKit {
	...
	class ImportBubbleWindow : EditorWindow {
		...
		protected void OnGUI () {
			...
			EditorGUILayout.Space ();
			_saveToDisk = EditorGUILayout.ToggleLeft ("Load Metadata", _loadMetadata);
			EditorGUILayout.Space ();
			_saveToDisk = EditorGUILayout.ToggleLeft ("Load Mesh & Materials", _loadMesh);
